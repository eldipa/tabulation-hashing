...
class TestTabulationHashing(unittest.TestCase):
    ...
    def test_hash_32_32_vec_callers_out(self):
        thashing = TabulationHashing(32, 32, 0, batch_len=4)
        xvec = np.array([
            0x0000000f,
            0x00000f00,
        ...
        # Just a "dirty" out buffer: hash_vec should zeroed it
    ...
    def test_hash_32_64_vec_callers_out(self):
